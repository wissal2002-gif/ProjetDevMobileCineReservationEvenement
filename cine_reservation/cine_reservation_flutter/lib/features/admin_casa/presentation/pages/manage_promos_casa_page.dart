...
class ManagePromosCasaPage extends ConsumerStatefulWidget {
  const ManagePromosCasaPage({super.key});

  @override
  ConsumerState<ManagePromosCasaPage> createState() => _ManagePromosCasaPageState();
}

class _ManagePromosCasaPageState extends ConsumerState<ManagePromosCasaPage> {
  String _searchQuery = "";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        heroTag: "fab_promo_casa_unique",
        onPressed: () => _showPromoDialog(context),
        label: const Text("NOUVEAU CODE (CASA)", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text("GESTION DES CODES PROMO - CASA",
        ...
        trailing: Row(
          ...
          children: [
            IconButton(
                ...
                onPressed: () => _showPromoDialog(context, promo: p)
            ),
            IconButton(
      ...
      builder: (context) => StatefulBuilder(builder: (context, setSt) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            _field(code, "CODE", isNumber: false),
