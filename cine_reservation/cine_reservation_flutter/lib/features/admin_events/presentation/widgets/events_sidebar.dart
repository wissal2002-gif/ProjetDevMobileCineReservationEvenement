...
class EventsSidebar extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 15),
          const Text("RESP. ÉVÉNEMENTS", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, letterSpacing: 1.2)),
          Text("Gestion des Spectacles & Festivals", style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 10)),
        ],
      ),
    );
  }
  ...
  Widget _sectionTitle(String title) {
    return Padding(
      ...
      child: Text(title, style: TextStyle(color: AppColors.accent.withOpacity(0.6), fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1)),
    );
  }
}
