...
class ManageEventsEventsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Détection du Pixel 7 ou mobile
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          // Sidebar masqué sur mobile (Pixel 7)
                  ...
                  child: eventsAsync.when(
                    data: (events) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) => _buildEventCard(context, ref, events[index], isMobile),
                      );
                    },
  ...
  // Widget du bouton d'ajout réutilisable
  ...
  Widget _buildEventCard(BuildContext context, WidgetRef ref, Evenement event, bool isMobile) {
    return Card(
  ...
  void _deleteDialog(BuildContext context, WidgetRef ref, Evenement event) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text("Voulez-vous supprimer '${event.titre}' ?", style: const TextStyle(color: Colors.white70)),
        actions: [
