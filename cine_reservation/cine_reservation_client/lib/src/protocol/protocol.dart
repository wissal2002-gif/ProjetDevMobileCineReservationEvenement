...
import 'package:cine_reservation_client/src/protocol/reservation.dart' as _i23;
...
import 'package:cine_reservation_client/src/protocol/film.dart' as _i28;
import 'package:cine_reservation_client/src/protocol/evenement.dart' as _i29;
import 'package:cine_reservation_client/src/protocol/utilisateur.dart' as _i30;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i29.Evenement>) {
      return (data as List).map((e) => deserialize<_i29.Evenement>(e)).toList()
          as T;
    }
    if (t == List<_i30.Utilisateur>) {
      return (data as List)
              .map((e) => deserialize<_i30.Utilisateur>(e))
              .toList()
          as T;
    }
