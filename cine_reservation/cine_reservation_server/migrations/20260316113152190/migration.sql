...
-- ACTION ALTER TABLE
--
DROP INDEX "favori_unique_idx";
ALTER TABLE "favoris" ADD COLUMN "filmId" bigint;
ALTER TABLE "favoris" ALTER COLUMN "cinemaId" DROP NOT NULL;
CREATE INDEX "favori_film_idx" ON "favoris" USING btree ("utilisateurId", "filmId");
CREATE INDEX "favori_cinema_idx" ON "favoris" USING btree ("utilisateurId", "cinemaId");
--
-- ACTION CREATE TABLE
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('cine_reservation', '20260316113152190', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260316113152190', "timestamp" = now();
